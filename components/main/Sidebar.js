...
const DefaultSidebar = () => (
  <div className="fixed top-0 left-0 h-full w-[200px] bg-white py-6 text-gray-700 shadow-md">
    ...
    <Menu>
      ...
      <button onClick={signOut} className="p-2 mx-4 justify-self-end bg-red-500 text-white rounded-md hover:bg-red-600">Logout</button>
    </Menu>
  </div>
);

const AdminSidebar = () => (
  <div className="fixed top-0 flex flex-col left-0 h-full w-[200px] bg-white py-6 text-gray-700 shadow-md">
