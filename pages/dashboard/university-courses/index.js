      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-12 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold">University Medical Courses</h1>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-80 space-y-4">
            ...
            <button
              ...
              className="lg:hidden w-full bg-white p-4 rounded-lg shadow-md flex items-center justify-between"
            >
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {courses.map((course) => (
                  ...
                  >
                    ...
                    <div className="h-32 bg-gradient-to-r from-blue-500 to-indigo-500 relative overflow-hidden">
